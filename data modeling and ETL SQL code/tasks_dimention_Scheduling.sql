...
-- We don't want historical date, we need current date --
        );
...
CREATE OR REPLACE TASK TPCDS.ANALYTICS.populating_customer_dimension_using_scd_type_2
...
ALTER TASK TPCDS.ANALYTICS.populating_customer_dimension_using_scd_type_2 RESUME;
EXECUTE TASK TPCDS.ANALYTICS.populating_customer_dimension_using_scd_type_2;
